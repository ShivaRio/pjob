          ...
          <div className="title-holder">
            <Container>
              <Row>
                <Col>
                  <h1 className="Abt">
                    <b>The Complete MongoDB course</b>
                  </h1>
                  <h2 className="Abt1">
                  ...
                  <p className="para">
                    ...
                    <b>
                      <li>
                        Have a detailed understanding of MongoDB databases and
                        how they work
                      </li>
                      <li>
                      ...
                      <li>
                        Have extensive hands-on experience with Query,
                        Projection and Pipeline Operators
                      </li>
                      <li>Query data using the Aggregation Framework</li>
                      <li>Use Indexes to make your queries more efficient</li>
                      <li>
                        Understand different approaches to modelling data in
                        MongoDB (Embedding vs Referencing)
                      </li>
                      <li>Use Drivers to connect MongoDB to applications</li>
                      <li>Work with forms on a Bootstrap grid</li>
                      <li>Create Accordions to manage content</li>
                      <li>Create standard and inverted navigation bars</li>
                      <li>Create dropdowns</li>
                      <li>Create a basic carousel</li>
                    </b>
                  </p>
            ...
            <Row>
              <Col>
                ...
                <p className="para1">
                  ...
                  <b>
                    <li>
                      This course is for anyone interested in learning about
                      NoSQL and MongoDB Databases
                    </li>
                  </b>
                </p>
                <h3 className="Abt4">
                ...
                <p className="para1">
                  <b>
                    MongoDB is one of the most in demand databases around
                    despite being relatively new to the<br /> scene. In fact, MongoDB
                    was created due to the limitations of traditional databases!
                    Due to the<br /> changing data demands of today and the growth in
                    “big data”, traditional relational databases<br /> are finding it
                    increasingly difficult to store this data and deliver
                    performance. MongoDB is able<br /> to handle large volumes of data
                    while maximising performance and adopt a flexible schema<br />
                    approach, giving you ultimate flexibility when modelling
                    data. These are just a few of the reasons<br /> why MongoDB is
                    rated as one of the top 5 most popular database systems in
                    the world according<br /> to Statista (as of June 2021). So if you
                    work with data in any capacity and are looking to develop
                    your<br /> experience of MongoDB then this is the perfect course
                    for you! The curriculum is comprehensive<br /> and is designed to
                    take you from beginner to pro. The lectures in this course
                    are arranged into short,<br /> bite-sized chunks.
                  </b>
                </p>
              </Col>
            </Row>
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt6">
                  <b>MongoDB Course Topics You will Learn</b>
                </h1>
              </Col>
            </Row>
            <br />
                ...
                <UncontrolledAccordion defaultOpen="0">
                  <AccordionItem className="Accord1 ms-5">
                    ...
                    <AccordionBody accordionId="1">
                      ...
                      <li>MongoDB Ecosystem</li>
                      <li>Advantages of MongoDB Databases</li>
                      <li>MongoDB Query Languages</li>
                    </AccordionBody>
                  </AccordionItem>
                  <AccordionItem className="Accord2 ms-5">
                    ...
                    <AccordionBody accordionId="2">
                      <li>Setting Up Your Atlas Cluster</li>
                      <li>Installing the Shell and Database Tools</li>
                      <li>Installing MongoDB Compass</li>
                      <li>Loading your Sample Data + MongoDB Compass Overview</li>
                      <li>Overview of MongoDB Atlas</li>
                    </AccordionBody>
                  </AccordionItem>
                  <AccordionItem className="Accord3 ms-5">
                    ...
                    <AccordionBody accordionId="3">
                      <li>Using Compass to Import/Export Collections</li>
                      <li>Command Line basics</li>
                      <li>mongoimport and mongoexport</li>
                  ...
                  <AccordionItem className="Accord4 ms-5">
                    ...
                    <AccordionBody accordionId="4">
                      <li>Creating / Deleting Databases and Collections</li>
                      <li>Assignment Questions</li>
                      <li>Comparison Operators</li>
                      <li>Logical Operators</li>
                      <li>Element Operators</li>
                      <li>Cursor Methods</li>
                      <li>Querying Embedded Documents</li>
                      <li>Querying Arrays</li>
                  ...
                  <AccordionItem className="Accord4 ms-5">
                    ...
                    <AccordionBody accordionId="5">
                      <li>Updating Documents in the Shell</li>
                      <li>Update Operators</li>
                      <li>Upsert</li>
                      <li>Updating Documents in Atlas</li>
                    </AccordionBody>
                  </AccordionItem>
                  <AccordionItem className="Accord4 ms-5">
                    ...
                    <AccordionBody accordionId="6">
                      <li>Assignment Questions</li>
                      <li>Arithmetic Expression Operators</li>
                      <li>String Expression Operators</li>
                      <li>Date Expression Operators</li>
                      <li>Comparison Expression Operators</li>
                      <li>Array Expression Operators</li>
                      <li>Conditional Expression Operators</li>
                      <li>Aggregation Expression Operators</li>
                      <li>Assignment Questions</li>
                      <li>$addFields</li>
                      <li>$group</li>
                      <li>$bucket and $bucketAuto</li>
                      <li>$sortByCount</li>
                      <li>$unwind</li>
                    </AccordionBody>
                  </AccordionItem>
                  ...
                  <AccordionItem className="Accord4 ms-5">
                    ...
                    <AccordionBody accordionId="8">
                      ...
                      <li>Data Modelling Considerations</li>
                      <li>$lookup</li>
                  ...
                  <AccordionItem className="Accord4 ms-5">
                    ...
                    <AccordionBody accordionId="9">
                      <li>The Explain Method</li>
                      <li>Single Field Indexes</li>
                      <li>Compound Indexes</li>
                      <li>Arrays and Embedded Fields</li>

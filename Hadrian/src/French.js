                ...
                <Col>
                  ...
                  <p className="para">
                    ...
                    <b>
                      ...
                      French online learning platform. With our comprehensive
                      French preparation program, you will have all the
                      resources you need to ace the exam. Whether you are a
                      student looking to improve your grades or a teacher
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt4">
                  <b>French Course Overview</b>
                </h1>
                <p className="para1">
                  <br />
                  <b>
                    Our free French courses are an online adaptation of the PJOP
                    French basic course.<br /> We propose 2 main courses: French for
                    beginners and Intermediate French. Each<br /> course includes 12
                    free french lessons. With our online French lessons, you
                    will be<br /> able to learn to speak French by listening to French
                    words, French phrases and<br /> French dialogues. Each lesson also
                    includes simple explanations of French grammar<br /> and many
                    examples of French grammar in use. You will also be able to
                    test your<br /> French language skills with quizzes and exercises.
                    The website can also be useful<br /> to people who wish to learn
                    or review particular aspects of French grammar, learn<br /> more
                    about French proverbs and sayings or French slang and
                    idioms. You will also<br /> be able to discover some popular
                    French songs (all with music video, French lyrics<br /> and
                    English translation). Learning French language through music
                    can be a fun<br /> and rewarding experience. We hope you enjoy
                    learning French language with our<br /> free online lessons and
                    tutorials.
                  </b>
                </p>
              </Col>
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt6">
                  <b>French Topics You will Learn</b>
                </h1>
              </Col>
            </Row>
            <br />

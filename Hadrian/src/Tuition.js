                ...
                <div className="text-center mt-5">
                  <a className="img-ho">
                    <Link to={"/maths"} onClick={scrollToTop}>
                      <Image
                        src={require("../src/assets/images/landingpage/A1-Maths4.jpg")}
                        className="a1"
                      ></Image>
                    </Link>
                  </a>
                ...
                <div className="text-center mt-5">
                  <a href="#" className="img-ho">
                    <Link to={"/physics"} onClick={scrollToTop}>
                      <Image
                        src={require("../src/assets/images/Tuition-centre/physics.jpg")}
                        className="a1"
                      ></Image>
                    </Link>
                  </a>
                ...
                <div className="text-center mt-5">
                  <a href="#" className="img-ho">
                    <Link to={"/chemistry"} onClick={scrollToTop}>
                      <Image
                        src={require("../src/assets/images/Tuition-centre/chemistry.jpg")}
                        className="a1"
                      ></Image>
                    </Link>
                  </a>
                ...
                <div className="text-center mt-5">
                  <a href="#" className="img-ho">
                    <Link to={"/french"} onClick={scrollToTop}>
                      <Image
                        src={require("../src/assets/images/Tuition-centre/french.jpg")}
                        className="a1"
                      ></Image>
                    </Link>
                  </a>
                ...
                <div className="text-center mt-5">
                  <a href="#" className="img-ho">
                    <Link to={"/computer"} onClick={scrollToTop}>
                      <Image
                        src={require("../src/assets/images/Tuition-centre/computer.jpg")}
                        className="a1"
                      ></Image>
                    </Link>
                  </a>
                ...
                <div className="text-center mt-5">
                  <a href="#" className="img-ho">
                    <Link to={"/accountancy"} onClick={scrollToTop} >
                      <Image
                        src={require("../src/assets/images/Tuition-centre/accountancy.jpg")}
                        className="a1"
                      ></Image>
                    </Link>
                  </a>

            ...
            <Col>
              ...
              <p className="para1">
                ...
                <b>
                  ...
                  implementing
                  <br /> the plan for designing a website in a way that is
                  functional and offers a good
                  <br /> user experience. User experience is central to the web
                  designing process.
                  <br /> Websites have an array of elements presented in ways
                  that make them easy
                  <br /> to navigate. Web designing essentially involves working
                  on every attribute of
                  <br /> the website that people interact with, so that the
                  website is simple and
                  <br /> efficient, allows users to quickly find the information
                  they need, and looks
                  <br /> visually pleasing. All these factors, when combined,
                  decide how well the
                  <br /> website is designed.
                </b>
              </p>
            </Col>
          </Row>

  ...
  // import certification from "../../../public/assets/images/landingpage/certification.jpg";
  // import online from "../../../public/assets/images/landingpage/online.jpg";
  // import fulltime from "../../../public/assets/images/landingpage/fulltime.jpg";
  // import access from "../../../public/assets/images/landingpage/access.jpg";
  // import support from "../../../public/assets/images/landingpage/support.jpg";
  // import refund from "../../../public/assets/images/landingpage/refund.jpg";
        ...
        <div className="header1 po-relative">
          <Container>
            <Navbar className="navbar-expand-lg h1-nav">
              <NavbarBrand href="/">
                <Image src={require("../src/assets/images/logos/pjop.png")} className="custom-pjop"/>
              </NavbarBrand>
                ...
                <Row>
                  <Col>
                    ...
                    <p className="para">
                      <br />
                      <b>
                        Take the first step towards academic success with our
                        Accountancy online learning platform. With our
                        comprehensive Accountancy preparation program, you will
                        have all the resources you need to ace the exam. Whether
                        you are a student looking to improve your grades or a
                        teacher looking to prepare your class, our platform is the
                        perfect solution.
                      </b>
                    </p>
          ...
          <div className="title-holder">
            <Container>
              <Row>
                <Col>
                  <h1 className="Abt4">
                    <b>Accountancy Course Overview</b>
                  </h1>
                  <p className="para1">
                    <br />
                    <b>
                      With our online accounting courses, learn how to
                      control and monitor a company's cash<br /> transactions. Our
                      fundamentals of accounting classes will teach you basic
                      accounting<br /> principles and concepts so you can properly
                      analyse financial accounts. We also have<br /> training courses
                      that focus on the principles and core practices of
                      accounting. Want to<br /> learn about accounting transactions,
                      processes, and controls used to record typical<br /> transactions
                      in a business? Our diploma in accounting advanced controls
                      and<br /> transactions is exactly what you’re looking for. Get
                      started, today.
                    </b>
                  </p>
                </Col>
            ...
            <Container>
              ...
              <Row>
                <Col>
                  <div className="">
                  <Image
                  src={require("../src/assets/images/landingpage/certification.jpg")}
                ...
                <Col md={8}>
                  <div className="">
                  <Image
                  src={require("../src/assets/images/landingpage/online.jpg")}
                  className="online"
                ></Image>{" "}
                    <b style={{ color: "black" }}>
              ...
              <Row>
                <Col>
                  <div className="">
                  <Image
                  src={require("../src/assets/images/landingpage/fulltime.jpg")}
                  className="fulltime"
                ></Image>{" "}
                    <b style={{ color: "black" }}>
                ...
                <Col md={8}>
                  <div className="">
                  <Image
                  src={require("../src/assets/images/landingpage/access.jpg")}
                  className="access"
                ></Image>{" "}
                    <b style={{ color: "black" }}>
              ...
              <Row>
                <Col>
                  <div className="">
                  <Image
                  src={require("../src/assets/images/landingpage/support.jpg")}
                  className="support"
                ></Image>{" "}
                ...
                <Col md={8}>
                  <div className="">
                  <Image
                  src={require("../src/assets/images/landingpage/refund.jpg")}
                  className="refund"
                ></Image>{" "}
          ...
          <div className="title-holder">
            <Container>
              <Row>
                <Col>
                  <h1 className="Abt6">
                    <b>Accountancy Topics You will Learn</b>
                  </h1>
                </Col>
              </Row>
              <br />

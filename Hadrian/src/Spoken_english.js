...
export default function Spoken_english() {
                ...
                <Col>
                  ...
                  <p className="para">
                    ...
                    <b>
                      ...
                      and idioms, and how to use them in real life. You will
                      learn the most important English grammar with tons of
                      English-speaking practice. You will learn to think in
                      English and to speak English fluently. (in Intermediate
                      level) You will learn to read in English and to spell
                      English words intuitively You will learn to understand
                      movies and TV shows in English. After the course, you can
                      travel the world freely, without a language barrier After
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt4">
                  <b>SPOKEN ENGLISH Overview</b>
                </h1>
                <p className="para1">
                  <br />
                  <b>
                    It is not a short basic course of English language. It is a
                    full beginner to intermediate course<br /> of spoken English. It
                    is specifically designed to help you build all the necessary
                    skills for the<br /> real-life day-to-day use. It is a 100%
                    animated and interactive spoken English language course,<br />
                    which makes it very fun to use. You get over 77 hours of
                    intensive spoken English language<br /> practice. Each English
                    language lesson lasts about 1 hour and a half. It is 100%
                    communicative<br /> intensive spoken English language course. You
                    speak English language all the time and you<br /> say over 2000
                    English words in each lesson. LOGUS doesn't teach you
                    separate English words.<br /> You learn everything only in the
                    context. LOGUS is the only online video course obsessed with<br />
                    perfecting your speech fluency. What good is your knowledge
                    of English grammar and words<br /> if you can't speak English
                    fluently? Your fluency is our number 1 priority. English
                    grammar is<br /> explained in extremely simple and intuitive way,
                    with tons of examples and many hours of<br /> listening and
                    speaking practice.
                  </b>
                </p>
              </Col>
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt6">
                  <b>SPOKEN ENGLISH Course Topics You will Learn</b>
                </h1>
              </Col>
            </Row>
            <br />

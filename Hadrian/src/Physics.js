                ...
                <Col>
                  ...
                  <p className="para">
                    ...
                    <b>
                      ...
                      Physics online learning platform. With our comprehensive
                      A1 Maths preparation program, you will have all the
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt4">
                  <b>Physics Course Overview</b>
                </h1>
                <p className="para1">
                  <br />
                  <b>
                    What is physics? Physics is the study of the natural world,
                    covering the<br /> behavior of matter and energy. It explores the
                    fundamental laws and<br /> principles that govern the universe,
                    such as motion, energy, force, and<br /> gravity. It applies these
                    laws and principles to explain the behavior of<br /> objects and
                    systems. Physics also seeks to understand and predict how<br />
                    these objects and systems will interact & behave in
                    different conditions.<br />Footnote1 Physicists and other
                    scientists use physics to test hypotheses<br /> and solve
                    problems. Its purpose is to create scientific laws,
                    typically<br /> expressed mathematically, so that other natural
                    phenomena can be<br /> predicted and explained.
                  </b>
                </p>
              </Col>
            </Row>
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt6">
                  <b>Physics Topics You will Learn</b>
                </h1>
              </Col>
            </Row>
            <br />

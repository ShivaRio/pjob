          ...
          <div className="title-holder">
            <Container>
              <Row>
                <Col>
                  <h1 className="Abt">
                    <b>Bootstrap Responsive Design</b>
                  </h1>
                  <h2 className="Abt1">
                  ...
                  <p className="para">
                    <br />
                    <b>
                      <li>How to include Bootstrap libraries</li>
                      <li>Understand how to apply Bootstrap themes</li>
                      <li>Use Basic Bootstrap grids</li>
                      <li>
                        Be able to create grids for mobile, tablet and desktop
                        using Bootstrap
                      </li>
                      <li>Adjust alignment using Bootstrap</li>
                      <li>Add striped rows to a table using Bootstrap</li>
                      <li>Create a bordered table using Bootstrap</li>
                      <li>Understand form groups</li>
            ...
            <Row>
              <Col>
                ...
                <p className="para1">
                  ...
                  <b>
                    <li>
                      Web Designers or Developers who want an easy responsive
                      framework
                    </li>
                    <li>
                ...
                <p className="para1">
                  <b>
                    Bootstrap is a visual, client-side framework that lets you
                    build gorgeous mobile apps<br /> and build those into full
                    screen-compliant applications. And, if you're going to learn<br />
                    Bootstrap, there is no better way then from our course
                    Bootstrap Responsive Design.<br /> In this course expert developer
                    and master instructor Mark Lassoff will take you from<br /> the
                    very fundamentals of development with Bootstrap to applying
                    techniques like<br /> Grids and Navigation bars.
                  </b>
                </p>
              </Col>
            </Row>
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt6">
                  <b>Bootstrap Course Topics You will Learn</b>
                </h1>
              </Col>
            </Row>
            <br />
                ...
                <UncontrolledAccordion defaultOpen="0">
                  <AccordionItem className="Accord1 ms-5">
                    ...
                    <AccordionBody accordionId="1">
                      <li>Including Bootstrap Libraries</li>
                      <li>Boostrap starter Template</li>
                      <li>Boostrap Themes</li>
                  ...
                  <AccordionItem className="Accord2 ms-5">
                    ...
                    <AccordionBody accordionId="2">
                      <li>Basic Grids and Media Queries</li>
                      <li>Stacked to Horizontal Grids</li>
                      <li>Mobile and Tablet Grids</li>
                      <li>Mobile, Tablet and Desktop Grids</li>
                    </AccordionBody>
                  </AccordionItem>
                  <AccordionItem className="Accord3 ms-5">
                    ...
                    <AccordionBody accordionId="3">
                      <li>Headings, Body and Lead Body Copy</li>
                      <li>Underline, Small, Bold, Italics</li>
                      <li>Alignment, Transformation and Abbreviation</li>
                      <li>Lists and Description Lists</li>
                      <li>Codes, Keyboards and Variables</li>
                    </AccordionBody>
                  </AccordionItem>
                  <AccordionItem className="Accord4 ms-5">
                    ...
                    <AccordionBody accordionId="4">
                      <li>Basic Table</li>
                      <li>Adding Striped Rows</li>
                      <li>Creating a Bordered Table</li>
                      <li>Hover Table</li>
                      <li>Responsiveness and Tables</li>
                    </AccordionBody>
                  </AccordionItem>
                  <AccordionItem className="Accord4 ms-5">
                  ...
                  <AccordionItem className="Accord4 ms-5">
                    ...
                    <AccordionBody accordionId="8">
                      <li>Standard and Inverted Navigation Bars</li>
                      <li>Dropdowns</li>
                      <li>Buttons and Forms in Navbars</li>
                    </AccordionBody>
                  </AccordionItem>
                  <AccordionItem className="Accord4 ms-5">
                    ...
                    <AccordionBody accordionId="9">
                      <li>Creating a Basic Carousel</li>

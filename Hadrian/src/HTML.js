          ...
          <div className="title-holder">
            <Container>
              <Row>
                <Col>
                  <h1 className="Abt">
                    <b>The Complete Guide to HTML</b>
                  </h1>
                  <h2 className="Abt1">
                  ...
                  <p className="para">
                    <br />
                    <b>
                      Create well-structured web pages with HTML Create complex
                      HTML forms Understand web accessibility and create
                      accessible webpages Work with HTML tables, links, images,
                      audio, video, and more! Use semantic elements .
                    </b>
                  </p>
            ...
            <Row>
              <Col>
                ...
                <p className="para1">
                  <br />
                  <b>
                    Every single website uses HTML - even this very course
                    landing page! It’s an absolutely<br /> fundamental tool that every
                    web developer uses daily, and it also happens to be very<br />
                    easy (and even fun) to learn. HTML is the language that
                    provides all the content on a<br /> webpage: the text, images,
                    links, forms, videos, and more! Learning HTML is the first<br />
                    step in any web development journey, and this course teaches
                    you all the HTML you<br /> need to know. This course starts at the
                    very beginning and covers all the essential<br /> HTML elements
                    and tags. You’ll learn how to work with text elements,
                    links, images,<br /> audio, video, tables, forms, and semantic
                    elements. By the end of the course you’ll be<br /> an HTML master.
                    The whole course can be completed in a
                    single day!
                  </b>
                </p>
                <h3 className="Abt4"><b>About HTML Course :</b></h3>
                <p className="para1">
                  <br />
                  <b>
                  You'll learn about dozens of HTML elements, including :<br />
                    <FaPlay
                        className="Play"
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt6">
                  <b>HTML Course Topics You will Learn</b>
                </h1>
              </Col>
            </Row>
            <br />

              ...
              <Row>
                <Col>
                  ...
                  <p className="para">
                    <br />
                    <b>
                      You are just starting to become a graphic designer and You
                      are a complete beginner who has never opened CorelDRAW You
                      have played around with CorelDRAW, but need some clarity
                      in becoming a more skilled graphic designer You are an
                      entrepreneur who wants to save money
                      <br /> by creating your own promotionals You are a
                      Marketer who got tired of waiting for a proposal from the
                      Advertising Agency on you next flyer and poster design.
                    </b>
                  </p>
                ...
                <p className="para1">
                  ...
                  <b>
                    ...
                    <FaPlay
                      ...
                      />
                    Creating a document to start with<br />
                    <FaPlay
                        className="Play"
                        style={{ marginRight: "10px" }}
                      /> 
                    Creating shapes to be used
                    in your layout<br />
                    <FaPlay
                        className="Play"
                        style={{ marginRight: "5px" }}
                      />  Combining shapes to create logos and
                    graphical elements<br />
                    <FaPlay
                        className="Play"
                        style={{ marginRight: "5px" }}
                      />  Using custom color palettes<br />
                       <FaPlay
                        className="Play"
                        style={{ marginRight: "5px" }}
                      /> Editing text
                    and installing fonts<br /> 
                    <FaPlay
                        className="Play"
                        style={{ marginRight: "5px" }}
                      /> Aligning and grouping objects<br />
                         <FaPlay
                        className="Play"
                        style={{ marginRight: "5px" }}
                      /> Importing
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt6">
                  <b>CORELDRAW Course Topics You will Learn</b>
                </h1>
              </Col>
            </Row>
            <br />

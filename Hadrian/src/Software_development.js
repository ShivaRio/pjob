                ...
                <Col>
                  ...
                  <p className="para">
                    ...
                    <b>
                      ...
                      using software development <br /> and master all of its
                      core concepts with this comprehensive <br />
            ...
            <Row>
              <Col>
                ...
                <p className="para1">
                  <br />
                  <b>
                    Software development is the process used to conceive,
                    specify, design, program,
                    <br /> document, test, and bug fix in order to create and
                    maintain applications,
                    <br /> frameworks, or other software components. Software
                    development involves
                    <br /> writing and maintaining the source code, but in a
                    broader sense, it includes
                    <br /> all processes from the conception of the desired
                    software through the final
                    <br /> manifestation, typically in a planned and structured
                    process often overlapping
                    <br /> with software engineering. Software development also
                    includes research,
                    <br /> new development, prototyping, modification, reuse,
                    re-engineering,
                    <br />
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt6">
                  <b>Software Development Course Topics You will Learn</b>
                </h1>
              </Col>
            </Row>
            <br />

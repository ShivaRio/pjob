          ...
          <div className="title-holder">
            <Container>
              <Row>
                <Col>
                  <h1 className="Abt">
                    <b>The Complete NodeJS Developer Course</b>
                  </h1>
                  <h2 className="Abt1">
                  ...
                  <p className="para">
                    <br />
                    <b>
                      <li>Completely refilmed for 3rd edition</li>
              ...
              <Col>
                ...
                <p className="para1">
                  ...
                  <b>
                    ...
                    <li>
                      A basic understanding of JavaScript (variables, functions,
                      objects, arrays, if statements)
                    </li>
                  </b>
                </p>
                <h3 className="Abt4">
                ...
                <p className="para1">
                  <b>
                    From the very start you’ll be programming every project and
                    working through<br /> challenges that I’ve designed to reinforce
                    what you’ve learned. This will give you<br /> the hands-on
                    experience necessary to be able to create and launch your
                    own<br /> project once you’re done. You’ll be building four
                    projects:
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt6">
                  <b>NodeJs Course Topics You will Learn</b>
                </h1>
              </Col>
            </Row>
            <br />
                ...
                <UncontrolledAccordion defaultOpen="0">
                  ...
                  <AccordionItem className="Accord2 ms-5">
                    ...
                    <AccordionBody accordionId="2">
                      <li>Importing NodeJs Core Modules</li>
                      <li>Importing Your Own Files</li>
                      <li>Importing NPM Modules</li>
                      <li>
                  ...
                  <AccordionItem className="Accord3 ms-5">
                    ...
                    <AccordionBody accordionId="3">
                      ...
                      <li>Storing Data with JSON</li>
                      <li>Adding a Note</li>
                      <li>ES6 Aside: Arrow Functions</li>
                      <li>Refactoring to Use Arrow Functions</li>
                    </AccordionBody>
                  </AccordionItem>
                  ...
                  <AccordionItem className="Accord4 ms-5">
                    ...
                    <AccordionBody accordionId="5">
                      ...
                      <li>Call Stack, Callback Queue, and Event Loop</li>
                      <li>Making HTTP Requests</li>
                      <li>Customizing HTTP Requests</li>
                      <li>Handling Errors</li>
                      <li>The Callback Function</li>
                      <li>Callback Abstraction</li>
                      <li>Callback Chaining</li>
                      <li>ES6 Aside: Object Property Shorthand and Destructuring</li>
                      <li>Destructuring and Property Shorthand Challenge</li>
                    </AccordionBody>
                  </AccordionItem>
                  <AccordionItem className="Accord4 ms-5">
                    ...
                    <AccordionBody accordionId="6">
                      <li>Serving up HTML and JSON</li>
                      <li>Serving up Static Assets</li>
                      <li>Serving up CSS, JS, Images, and More</li>
                      <li>Dynamic Pages with Templating</li>
                      <li>Customizing the Views Directory</li>
                      <li>Advanced Templating</li>
                    </AccordionBody>
                  </AccordionItem>
                  <AccordionItem className="Accord4 ms-5">
                    ...
                    <AccordionBody accordionId="7">
                      ...
                      <li>Building a JSON HTTP Endpoint</li>
                      <li>ES6 Aside: Default Function Parameters</li>
                      <li>Browser HTTP Requests with Fetch</li>
                      <li>Creating a Search Form</li>
                    </AccordionBody>
                  </AccordionItem>
                  <AccordionItem className="Accord4 ms-5">
                    ...
                    <AccordionBody accordionId="8">
                      <li>Joining Heroku and GitHub</li>
                  ...
                  <AccordionItem className="Accord4 ms-5">
                    ...
                    <AccordionBody accordionId="9">
                      <li>Section Intro: Databases and Advanced Asynchronous Development</li>
                      <li>MongoDB and NoSQL Databases</li>
                      <li>Installing Database GUI Viewer</li>
                      <li>Connecting and Inserting Documents</li>
                  ...
                  <AccordionItem className="Accord4 ms-5">
                    ...
                    <AccordionBody accordionId="10">
                      ...
                      <li>Creating a Mongoose Model</li>
                      <li>Structuring a REST API</li>
                      <li>Installing Postman</li>
                      <li>Promise Chaining</li>
                      <li>Async/Await</li>
                      <li>Integrating Async/Await</li>
                    </AccordionBody>
                  </AccordionItem>
                  <AccordionItem className="Accord4 ms-5">
                    <AccordionHeader targetId="11" className="">
                      <FaPlay
                        className="Play"
                        style={{ marginRight: "10px" }}
                      />
                    ...
                    <AccordionBody accordionId="11">
                      ...
                      <li>Accepting Authentication Tokens</li>
                      <li>Advanced Postman</li>
                      <li>Logging Out</li>
                      <li>Hiding Private Data</li>
                      <li>Authenticating User Endpoints</li>
                      <li>The User/Task Relationship</li>
                    </AccordionBody>
                  </AccordionItem>
                  <AccordionItem className="Accord4 ms-5">
                    <AccordionHeader targetId="12" className="">
                      <FaPlay
                        className="Play"
                        style={{ marginRight: "10px" }}
                      />
                    ...
                    <AccordionBody accordionId="12">
                      <li>Working with Timestamps</li>
                      <li>Filtering Data</li>
                      <li>Paginating Data</li>
                      <li>Sorting Data</li>
                    </AccordionBody>
                  </AccordionItem>
                  <AccordionItem className="Accord4 ms-5">
                    <AccordionHeader targetId="13" className="">
                      <FaPlay
                        className="Play"
                        style={{ marginRight: "10px" }}
                      />
                    ...
                    <AccordionBody accordionId="13">
                      ...
                      <li>Validation Challenge</li>
                      <li>Adding Images to User Profile</li>
                      <li>Serving up Files</li>
                      <li>Auto-Cropping and Image Formatting</li>
                    </AccordionBody>
                  </AccordionItem>
                </UncontrolledAccordion>
              </Col>

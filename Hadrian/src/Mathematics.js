              ...
              <Row>
                <Col>
                  ...
                  <p className="para">
                    <br />
                    <b>
                      Numbers and negative numbers, including number sets and
                      identity numbers Factors
                      <br /> and multiples, including prime numbers, least
                      common multiple and divisibility Decimals,
                      <br />
                      including repeating decimals and rounding Fractions,
                      including mixed numbers and ratio
                      <br /> and proportion Exponents, including negative and
                      fractional bases Radicals, including rationalizing the
                      denominator Scientific notation, including multiplication
                      and division, and estimating.
                    </b>
                  </p>
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt4">
                  <b>MATHEMATICS Overview</b>
                </h1>
                <p className="para1">
                  <br />
                  <b>
                    Watch over my shoulder as I solve problems for every
                    single math issue you’ll encounter<br /> in class. We start from
                    the beginning. I explain the problem setup and why I set
                    it up that way,<br /> the steps I take and why I take them, how to
                    work through the yucky, fuzzy middle parts, and<br /> how to
                    simplify the answer when you get it. The notes
                    section of each lesson is where you find<br /> the most important
                    things to remember. It’s like Cliff Notes for books, but for
                    math. Everything<br /> you need to know to pass your class and
                    nothing you don’t.When you think you’ve got a good<br />
                    grasp on a topic within a course, you can test your
                    knowledge by taking one of the quizzes. If<br /> you pass, great!
                    If not, you can review the videos and notes again or ask for
                    help in the Q&A<br /> section. Want even more practice?
                    When you've finished the section, you can review everything<br />
                    you've learned by working through the bonus workbook. The
                    workbooks include tons of extra<br /> practice problems, so
                    they're a great way to solidify what you just learned in
                    that section.
                  </b>
                </p>
                <h3 className="Abt4">
                  <b>About Mathematics Course :</b>
                </h3>
                <p className="para1">
                  <br />
                  <b>
                  HOW MASTER THE FUNDAMENTALS OF MATH IS SET UP TO MAKE COMPLICATED MATH EASY :
                    <br />
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt6">
                  <b>MATHEMATICS Course Topics You will Learn</b>
                </h1>
              </Col>
            </Row>
            <br />

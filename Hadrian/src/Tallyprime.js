              ...
              <Row>
                <Col>
                  ...
                  <p className="para">
                    <br />
                    <b>
                      In-depth knowledge of Tally Prime from basic to Cost
                      Centre, Budgeting, TDS, GST, AR/AP, & many more. A
                      complete knowledge of fundamentals of Accounting.This
                      course will give the
                      <br /> road to the individuals in the worldwide help
                      showcase An individual can start consultancy
                      <br /> of their own This course will increases the
                      opportunity of salary raise.
                    </b>
                  </p>
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt4">
                  <b>TALLYPRIME Overview</b>
                </h1>
                <p className="para1">
                  <br />
                  <b>
                    This course is an excellent option for those who want to
                    pursue a career in Accounting, Taxation<br /> and Financial
                    Reporting. This course will help you to get understand the
                    software in-depth and<br /> learn concepts related to Accounting,
                    Inventory Management, GST, TDS, Return filing, Payroll,<br /> and
                    many more. Various business firms are using this software as
                    it is easy to use and helps in<br /> keeping an error-free and
                    glitch-free record of a business’s accounts.No prior
                    accounting,<br /> finance, modeling or valuation experience is
                    required for this course.
                  </b>
                </p>
                <h3 className="Abt4"><b>About Advance Tally Prime Course :</b></h3>
                <p className="para1">
                  <br />
                  <b>
                    This course will cover everything you need to
                    start working on your graphic design files,including:<br />
                    <FaPlay
                        className="Play"
                        style={{ marginRight: "10px" }}
                      />
                    Commerce introduction, Accounting, Book-Keeping<br />
                    <FaPlay
                        className="Play"
                        style={{ marginRight: "10px" }}
                      /> 
                    Complete Guide to Accounting & Taxation<br />
                    <FaPlay
                        className="Play"
                        style={{ marginRight: "5px" }}
                      />  Accounting and Invoicing practices with use of Tally Prime software<br />
                    <FaPlay
                        className="Play"
                        style={{ marginRight: "5px" }}
                      />  TDS compliances with payment and return filing<br />
                       <FaPlay
                        className="Play"
                        style={{ marginRight: "5px" }}
                      /> GST compliances with payment and return filing<br /> 
                    <FaPlay
                        className="Play"
                        style={{ marginRight: "5px" }}
                    ...
                    <FaPlay
                        ...
                        style={{ marginRight: "10px" }}
                      /> 
                    Maintenance of Inventory Record<br />
                    <FaPlay
                        className="Play"
                        style={{ marginRight: "5px" }}
                      /> Sales and Purchased Order Processing<br />
                    <FaPlay
                        className="Play"
                        style={{ marginRight: "5px" }}
                      /> Accounts Receivable and Payable Management<br />
                       <FaPlay
                        className="Play"
                        style={{ marginRight: "5px" }}
                      /> Cost Centre Management<br /> 
                    <FaPlay
                        className="Play"
                        style={{ marginRight: "5px" }}
                      /> Budget and Scenario Management<br />
                         <FaPlay
                        className="Play"
                        style={{ marginRight: "5px" }}
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt6">
                  <b>TALLYPRIME Course Topics You will Learn</b>
                </h1>
              </Col>
            </Row>
            <br />

                ...
                <Col>
                  ...
                  <p className="para">
                    ...
                    <b>
                      ...
                      Computer online learning platform. With our comprehensive
                      Computer preparation program, you will have all the
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt4">
                  <b>Computer Course Overview</b>
                </h1>
                <p className="para1">
                  <br />
                  <b>
                    Computer Science is a very popular field of study among
                    students due to its very high demand<br /> in the job market.
                    Computer science graduates are required in almost every
                    organization in<br /> many roles ranging from computer operators,
                    networking engineers, software engineers and<br /> programmers.
                    Computer science is the study of Computer, how it functions,
                    their applications<br /> and usage in different fields. In a
                    computer science course, students study subjects like
                    operating<br /> systems, software, networking, hardware technology
                    and programming. Courses in computer<br /> science are offered at
                    diploma, degree and doctorate levels. A computer science
                    diploma is a<br /> basic course while the degree program at
                    undergraduate and postgraduate levels are of the<br /> advanced-level
                    courses.
                  </b>
                </p>
              </Col>
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt6">
                  <b>Computer Topics You will Learn</b>
                </h1>
              </Col>
            </Row>
            <br />

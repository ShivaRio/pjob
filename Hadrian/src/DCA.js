                ...
                <Col>
                  ...
                  <p className="para">
                    ...
                    <b>
                      ...
                      <br /> gain a globally recognized job-ready certificate
        ...
        {/* <div className="header-bar-one">
          <Container>
            ...
            <Link to={"/html"} onClick={scrollToTop} style={{color: "white"}}>
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <b onClick={() => navigate("/ms_office")}>Angular</b>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <Col>
                ...
                <p className="para1">
                  ...
                  <b>
                    ...
                    one-year course
                    <br /> in Computer Applications. This course involves the
                    study of various computer
                    <br />
                    applications such as MS Office, Internet Applications,
                    Operating Systems,
                    <br /> Database Management Systems (DBMS), HTML, and other
                    related subjects.
                    <br /> To apply for DCA admission, candidates should have
                    completed high school
                    <br /> or an equivalent degree in any discipline from a
                    recognized board with at
                    <br /> least 40% marks. The DCA Syllabus and subjects
                    include basic computer Skills,
                    <br />
                    MS Office Applications, Internet Basics, E-Business, PC
                    Assembly and
                    <br /> Troubleshooting. The average fee for DCA in India
                    ranges from INR 5,000 to
                    <br /> INR 30,000 for the complete duration. Students
                    looking for better career
                    <br />
                    opportunities can opt for other types of Computer
                    Application courses in
                    <br /> India such as BCA. Other computer application courses
                    in India include
                    <br /> BBA Computer Applications, BSc Computer Applications,
                    and BA

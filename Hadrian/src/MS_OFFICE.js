...
export default function MS_OFFICE() {
          ...
          <Container>
            <Row>
              <Col>
                ...
                <h1 className="Abt1">
                  <b>Step up your Career</b>
                </h1>
                <p className="para">
                  <br />
                  <b>
                  Unlock the full potential of MS Office and increase productivity at workplace. From Excel to PowerPoint, gain skills to streamline processes and create professional-grade documents and presentations.
                  </b>
                </p>
      ...
      <div className="title-holder">
        <Container>
          <Row>
            <Col>
              <h1 className="Abt4">
                <b>MS OFFICE Overview</b>
              </h1>
              <p className="para1">
                <br />
                <b>
                Discovery is just around the corner as you learn more about Microsoft Office.<br /> Dive into classes that explore tools, techniques and topics like Excel formulas<br /> and macros, PowerPoint animations, Microsoft Word shortcuts, and more.<br /> Whether you’re just getting started as a beginner with OneNote and Sharepoint,<br /> or you’re just looking to take your Word, Excel, and PowerPoint skills to the next<br /> level, these online tutorials, taught by experts and experienced professionals will<br /> help you advance your abilities. Master Microsoft Teams, forecast with Microsoft<br /> Excel, and design better PowerPoint slides. With the support of a community of<br /> creators, and short lessons with hands-on projects, you can improve your skills<br /> with these Skillshare classes.
                </b>
              </p>
            </Col>
          </Row>
      ...
      <div className="title-holder">
        <Container>
          <Row>
            <Col>
              <h1 className="Abt6">
                <b>MS OFFICE Course Topics You will Learn</b>
              </h1>
            </Col>
          </Row>
          <br />

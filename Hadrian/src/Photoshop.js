                ...
                <Col>
                  ...
                  <p className="para">
                    ...
                    <b>
                      ...
                      & get paid for their
                      <br /> Photoshop skills.Newbie's, amateurs, graphic
                      designers, motion graphics artists,
                      <br /> Illustrator users, and any creatives who want to
                      design their own graphics and
                      <br /> edit their own photos from scratch
                    </b>
                  </p>
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt4">
                  <b>PHOTOSHOP Overview</b>
                </h1>
                <p className="para1">
                  <br />
                  <b>
                    This course is for beginners. You do not need any previous
                    knowledge of Photoshop,<br /> photography or design. We will start
                    right at the beginning and work our way through<br /> step by
                    step. You will learn the Photoshop 'secret sauce' whereby we
                    will magically<br /> enhance our background and when necessary
                    completely remove people from images.<br /> There are exercise
                    files available to download so that you can follow along
                    with me in the<br /> videos. There are lots of assignments I will
                    set so that you can practice the skills you have<br /> learned.If you have never opened Photoshop before or you have already opened Photoshop<br /> and are struggling with the basics, follow me and together we will learn how to make<br /> beautiful images using Photoshop.
                  </b>
                </p>
              </Col>
            </Row>
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt6">
                  <b>PHOTOSHOP Course Topics You will Learn</b>
                </h1>
              </Col>
            </Row>
            <br />

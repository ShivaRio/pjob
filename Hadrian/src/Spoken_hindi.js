...
export default function Spoken_hindi() {
                ...
                <Col>
                  ...
                  <p className="para">
                    ...
                    <b>
                      ...
                      able to converse well in Hindi language with ease and
                      confidence.
                    </b>
                  </p>
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt4">
                  <b>SPOKEN HINDI Overview</b>
                </h1>
                <p className="para1">
                  <br />
                  <b>
                    Having spent a major part of my growing years in north
                    India, I am well- versed with day-to-day
                    <br /> aspects of spoken Hindi & its grammar and follow my
                    passion to conduct interactive spoken Hindi
                    <br /> classes. You will find this fun-filled and
                    interactive course very interesting, and at the end, you
                    will
                    <br /> be surprised at your own spontaneous responses and
                    conversations in Hindi with your friends and
                    <br />
                    colleagues, also during travel & shopping. This is a self
                    learning course package for Spoken Hindi
                    <br /> which contains 12 audio visual Modules covering
                    relevant topics in Spoken Hindi. They are simple
                    <br /> and easy to comprehend and you can go through them at
                    your own comfort and leisure time, learn
                    <br /> & repeat the lessons and pick up the language. In
                    addition there are 16 sets of audio visual dialogues<br />
                    among friends and colleagues on day to day basis, also
                    included in this package, will enhance and<br /> boost the
                    learning process.
                  </b>
                </p>
              </Col>
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt6">
                  <b>SPOKEN HINDI Course Topics You will Learn</b>
                </h1>
              </Col>
            </Row>
            <br />

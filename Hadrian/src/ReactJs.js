              ...
              <Row>
                <Col>
                  ...
                  <p className="para">
                    <br />
                    <b>
                      Everything you need to become a React developer with
                      basics to advanced concepts, how things works behind the
                      scenes and real projects Understand fundamentals:
                      Components & Props, State, Hooks, Context & Reducers and
                      more... Dive Deep with Custom Hooks, Tailwind CSS, React
                      Router, Redux, Firebase, React Skeleton & more... Build
                      real-world applications with React (E-Commerce, Movie
                      Informer, Todolist Manager, Blog, Word Counter & more)
                      Build mock ecommerce backend with JSON Auth Server and
                      deploy it on Railway Work with multiple API's to make the
                      most of third-party data (such as Movie information &
                      Jokes) Deploy your projects on Netlify using Git & Github
                      Test your application with Jest and React Testing Library
                      Learn with the latest versions: React 18 and JavaScript
                      ES13 Be in the top 10% Fresh React JS Developer And lot
                      more!
                    </b>
                  </p>
            ...
            <Row>
              <Col>
                ...
                <p className="para1">
                  <br />
                  <b>
                    Complete course is focused on the concept learning approach,
                    you learn every concept through<br /> a logical and visual
                    learning approach. Learn all important concepts in the
                    simplest possible way<br /> with examples and real-life projects.
                    You need HTML, CSS and JavaScript knowledge, we will cover<br />
                    everything about React step-by-step from scratch.
                  </b>
                </p>
                <h3 className="Abt4">
        ...
        <div className="title-holder">
          <Container>
            <Row>
              <Col>
                <h1 className="Abt6">
                  <b>ReactJs Course Topics You will Learn</b>
                </h1>
              </Col>
            </Row>
            <br />
                ...
                <UncontrolledAccordion defaultOpen="0">
                  ...
                  <AccordionItem className="Accord2 ms-5">
                    ...
                    <AccordionBody accordionId="2">
                      ...
                      <li>React Behind The Scene</li>
                      <li>Components: Class & Function Based</li>
                      <li>JSX: In-depth Introduction</li>
                      <li>Basic Template Structure</li>
                    </AccordionBody>
                  </AccordionItem>
                  <AccordionItem className="Accord3 ms-5">
                    ...
                    <AccordionBody accordionId="3">
                      <li>State Introduction: useState</li>
                      <li>useState: Multiple Updates</li>
                      <li>useState: Array State Value</li>
                      <li>useState: Array setState Value</li>
                  ...
                  <AccordionItem className="Accord4 ms-5">
                    ...
                    <AccordionBody accordionId="4">
                      <li>Multiple Components & Fragments</li>
                      <li>Props: In-depth Introduction </li>
                  ...
                  <AccordionItem className="Accord4 ms-5">
                    <AccordionHeader targetId="6" className="">
                      <FaPlay
                        ...
                        style={{ marginRight: "10px" }}
                      />
                      useEffect,useCallback and Custom Hooks
                    </AccordionHeader>
                    <AccordionBody accordionId="6">
                      ...
                      <li>Handling Errors (try/catch)</li>
                      <li>Aborting Fetch Request</li>
